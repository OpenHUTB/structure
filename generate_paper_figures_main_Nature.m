...
annotation(fig, 'textbox', ...
    [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.75, ...
    ax1.Position(3), 0.05], ...
    'string', {'surface mesh'}, 'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
annotation(fig, 'arrow', ...
    [ax1.Position(1)+ax1.Position(3), init_x+factor_x*length_x*(1+1.3-1)], ...
     (ax1.Position(2)+ax1.Position(4)*0.5)*ones(1,2), 'Color', 'k')
annotation(fig, 'textbox', ...
    [ax1.Position(1)+ax1.Position(3), ax1.Position(2)+ax1.Position(4)*0.55, ...
    0.05, 0.05], ...
    'string', '$\Delta \psi = -\lambda \psi$', 'edgecolor', 'none', ...
                'fontsize', fontsize_axis+2, 'fontweight', 'normal', ...
...
for mode_ind=1:num_modes_to_plot
    ...
    if mode_ind==num_modes_to_plot
        ax1 = axes('Position', ...
            [0.03+init_x+factor_x*length_x*(mode_ind+1.3-1) ...
            init_y+factor_y*length_y*(2-1) length_x length_y]);
    else
        ax1 = axes('Position', ...
            [init_x+factor_x*length_x*(mode_ind+1.3-1) ...
            init_y+factor_y*length_y*(2-1) length_x length_y]);
    end
    patch(ax1, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, ...
        'FaceVertexCData', basis_geometric(:,mode), ...
    ...
    if mode_ind==1
        annotation(fig, ...
            'textbox', ...
            [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.8, ...
            ax1.Position(3), 0.05], 'string', {'mode 1'; '\psi_1'}, ...
            'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
    elseif mode_ind==2
        annotation(fig, ...
            ...
            [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.8, ...
            ax1.Position(3), 0.05], ...
            'string', {'mode 2'; '\psi_2'}, 'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', 'verticalalignment', 'middle') 
    elseif mode_ind==3
        annotation(fig, 'textbox', ...
            [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.8, ...
            ax1.Position(3), 0.05], 'string', {'mode 3'; '\psi_3'}, ...
            'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', 'verticalalignment', 'middle')
    elseif mode_ind==4
        annotation(fig, 'textbox', ...
            [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.8, ...
            ax1.Position(3), 0.05], 'string', {'mode 4'; '\psi_4'}, ...
            'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', ...
        ...
        annotation(fig, 'textbox', ...
            [ax1.Position(1), ax1.Position(2)+ax1.Position(4)*0.8, ...
            ax1.Position(3), 0.05], 'string', {'mode N'; '\psi_N'}, ...
            'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', 'verticalalignment', 'middle')
    end
...
annotation(fig, 'textbox', ...
    [ax1.Position(1)-0.056, ax1.Position(2)+ax1.Position(4)*0.45, ...
    0.08, 0.02], 'string', '...', 'edgecolor', 'none', ...
            'fontsize', fontsize_axis*2, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', 'verticalalignment', 'middle')
annotation(fig, 'arrow', [0.07+init_x+factor_x*length_x*(1.5+1.3-1), 0.85], ...
                         (ax1.Position(2)+0.025)*ones(1,2), 'Color', 'k')
annotation(fig, 'textbox', ...
    [0.0+init_x+factor_x*length_x*(1.06+1.3-1), ax1.Position(2)+0.01, ...
    0.13, 0.02], 'string', {'low frequency /'; 'long wavelength'}, ...
    'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
annotation(fig, 'textbox', ...
    [0.855, ax1.Position(2)+0.01, 0.13, 0.02], ...
    'string', {'high frequency /'; 'short wavelength'}, ...
    'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
...
% b: 模式分解
ax2 = axes('Position', ...
    [init_x+factor_x*length_x*(1-1) init_y+factor_y*length_y*(1-1) ...
    length_x*3.5 length_y*2]);
xstart = 0.07;
ystart = 0.6;
t1 = text(xstart+0.35, ystart-0.25, ...
    '$\displaystyle y(\mathbf{r},t) = \sum_{j=1}^N a_j(t)\psi_j(\mathbf{r})$', ...
    'fontsize', fontsize_label*1.3, 'horizontalalignment', 'center', ...
    'verticalalignment', 'middle', 'interpreter', 'latex');
t2 = text(xstart, ystart-0.35, '$\displaystyle y$', ...
    'fontsize', fontsize_label*1.2, 'horizontalalignment', 'center', ...
    'verticalalignment', 'middle', 'interpreter', 'latex');
...
for mode_ind=1:4
    ...
    ax2_1 = axes('Position', ...
        [0.005+init_x+factor_x*length_x*(mode_ind-1)*0.76 ...
        init_y+factor_y*length_y*(0.8-1) ...
        length_x*0.4 length_y]);
    if mode_ind==1
        patch(ax2_1, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
            'FaceVertexCData', ...
            data_Figure1.task_map_emp.('social_tom_random'), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    else
        patch(ax2_1, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
...
% c: 数据
ax3 = axes('Position', ...
    [init_x+factor_x*length_x*(4.4-1) init_y+factor_y*length_y*(0.9-1) ...
    length_x*3 length_y*0.9]);
axis off
...
for ii=1:3
    ax3_1 = axes('Position', ...
        [ax3.Position(1)+ax3.Position(3)*(0.15+0.05*(ii-1)) ...
        ax3.Position(2)+ax3.Position(4)*(0.3-0.23*(ii-1)) ...
        length_x*0.4 length_y]);
    if ii==1
        patch(ax3_1, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
            'FaceVertexCData', data_Figure1.task_map_emp.('motor_cue_avg'), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    elseif ii==2
        patch(ax3_1, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
            'FaceVertexCData', ...
            data_Figure1.task_map_emp.('emotion_faces_shapes'), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    elseif ii==3
        patch(ax3_1, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
            'FaceVertexCData', data_Figure1.task_map_emp.('wm_2bk_0bk'), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    end
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    ...
    ax3_2 = axes('Position', ...
        [ax3_1.Position(1)+0.15 ax3_1.Position(2) ...
        ax3_1.Position(3) ax3_1.Position(4)]);
    patch(ax3_2, 'Vertices', surface_to_plot.vertices, 'Faces', ...
        surface_to_plot.faces, 'FaceVertexCData', data_to_plot(:,ii), ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    elseif strcmpi(hemisphere, 'rh')
    ...
    annotation(fig, 'textbox', ...
        [ax3_1.Position(1)-0.065, ax3_1.Position(2)+ax3_1.Position(4)*0.4, ...
        0.08, 0.02], 'string', sprintf('task %i', ii), 'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
    if ii==1
        annotation(fig, 'arrow', ...
            [ax3.Position(1)+ax3.Position(3)*(0.45+0.05*(1-1)), ...
                ax3.Position(1)+ax3.Position(3)*(0.47+0.05*(3-1))], ...
            [length_y*0.5+ax3.Position(2)+ax3.Position(4)*(0.3-0.22*(1-1)), ...
                length_y*0.4+ax3.Position(2)+ ...
                    ax3.Position(4)*(0.3-0.22*(3-1))], ...
             'HeadLength', 6, 'HeadWidth', 6, 'Color', 'k')
    end
    if ii==2
        annotation(fig, 'textbox', ...
            [ax3_2.Position(1)-0.068, ...
            ax3_2.Position(2)+ax3_2.Position(4)*0.35, ...
            0.08, 0.02], 'string', 'time', 'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
        annotation(fig, 'textbox', ...
            [ax3_1.Position(1)-0.05, ax3.Position(2)+ax3.Position(4)*1.05, ...
            ax3_1.Position(3)+0.03, 0.02], ...
            'string', 'task-evoked', 'edgecolor', 'none', ...
                'fontsize', fontsize_label, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle') 
        annotation(fig, 'textbox', ...
            [ax3_2.Position(1)+0.04, ax3.Position(2)+ax3.Position(4)*1.05, ...
            ax3_2.Position(3)+0.05, 0.02], ...
            'string', 'spontaneous', 'edgecolor', 'none', ...
                'fontsize', fontsize_label, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
    end
end
...
ax3_3 = axes('Position', ...
    [ax3.Position(1)+ax3.Position(3)*(0.62+0.05*(ii-1)) ...
    ax3.Position(2)+ax3.Position(4)*(1.4-1) length_x length_y*0.43]);
parc_name = 'Glasser360';
parc = dlmread(filename_common_parcellation(parc_name, hemisphere));
...
for ii=1:length(representative_contrasts)
    ...
    plot(nanmean(task_recon_corr_geometric.(contrast),1), ...
        'color', colors(ii,:), 'linewidth', 2, 'displayname', lower(tasks{ii}))
end
plot(nanmean(resting_recon_corr_geometric,1), ...
    'color', colors(ii+1,:), 'linewidth', 2, 'displayname', lower('REST'))
hold off;
leg = legend('fontsize', fontsize_axis, 'location', 'southeast', ...
    'interpreter', 'none', 'box', 'off', 'numcolumns', 1);
...
length_y = (ax5.Position(2)+ ...
    ax5.Position(4)-init_y)/(factor_y*(length(representative_contrasts)-1) + 1);
% 实证
for ii = 1:length(representative_contrasts)
    contrast = representative_contrasts{ii};
    ...
    ax6 = axes('Position', ...
        [init_x+factor_x*length_x*(1-1) ...
        init_y+factor_y*length_y*(length(representative_contrasts)-ii) ...
        length_x length_y]);
    patch(ax6, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    elseif strcmpi(hemisphere, 'rh')
    ...
    annotation(fig, 'textbox', ...
        [ax6.Position(1)-0.035, ax6.Position(2)+ax6.Position(4)*0.4, ...
        0.01, 0.01], ...
        'string', task_name, 'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'horizontalalignment', 'center', ...
            'verticalalignment', 'middle')
    if ii==1
        annotation(fig, 'textbox', ...
            [ax6.Position(1)+ax6.Position(3)*0.44, ...
            ax6.Position(2)+ax6.Position(4)*0.93, 0.01, 0.01], ...
            'string', 'data', 'edgecolor', 'none', ...
            'fontsize', fontsize_axis, 'horizontalalignment', 'center', ...
...
for ii = 1:length(representative_contrasts)
    ...
    for jj = 1:length(N_interest)
        ...
        if ii==1
            annotation(fig, 'textbox', ...
                [ax6.Position(1)+ax6.Position(3)*0.44-0.035, ...
                ax6.Position(2)+ax6.Position(4)*0.93, 0.08, 0.01], ...
                'string', {'recon'; sprintf('(N = %i)', N)}, ...
                'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'horizontalalignment', 'center', ...
                'verticalalignment', 'bottom')
        end
        ...
        if ii==1 && jj>=2
            annotation(fig, 'arrow', ...
                [ax6.Position(1)+ax6.Position(3)*0.6, ...
                ax6.Position(1)+ax6.Position(3)*0.57], ...
                                     [ax6.Position(2)+ax6.Position(4)*0.1, ...
                                     ax6.Position(2)+ax6.Position(4)*0.18], ...
                                     'LineStyle', 'none', 'HeadLength', 6, ...
                                     'HeadWidth', 6, 'Color', 'k')
            annotation(fig, 'arrow', [ax6.Position(1)+ax6.Position(3)*0.87, ...
                ax6.Position(1)+ax6.Position(3)*0.84], ...
                                     [ax6.Position(2)+ax6.Position(4)*0.24, ...
                                     ax6.Position(2)+ax6.Position(4)*0.32], ...
                                     'LineStyle', 'none', 'HeadLength', 6, ...
                                     'HeadWidth', 6, 'Color', 'k')
        elseif ii==2 && jj>=2
            annotation(fig, 'arrow', ...
                [ax6.Position(1)+ax6.Position(3)*0.82, ...
                ax6.Position(1)+ax6.Position(3)*0.79], ...
                                     [ax6.Position(2)+ax6.Position(4)*0.8, ...
                                     ax6.Position(2)+ax6.Position(4)*0.72], ...
                                     'LineStyle', 'none', 'HeadLength', 6, ...
                                     'HeadWidth', 6, 'Color', 'k')
        end
    end
...
for jj = 1:length(N_interest)
    N = N_interest(jj);
    annotation(fig, ...
        'line', (ax5.Position(1)+ax5.Position(3)*(N/num_modes))*ones(1,2), ...
             [init_y*0.75, init_y*(yloc_min+yloc_space*(jj-1))], ...
             'Color', 'k', 'LineStyle', ':', 'linewidth', 1.5)
    annotation(fig, ...
        'line', [ax5.Position(1)+ax5.Position(3)*(N/num_modes), ...
            init_x+factor_x*length_x*(jj)+length_x*0.5], ...
                 (init_y*(yloc_min+yloc_space*(jj-1)))*ones(1,2), ...
                 'Color', 'k', 'LineStyle', ':', 'linewidth', 1.5)
    annotation(fig, ...
        'arrow', init_x+factor_x*length_x*(jj)+length_x*0.5*ones(1,2), ...
    ...
    inset_length = 0.05;
    ax5_inset = axes('Position', ...
        [ax5.Position(1)+ax5.Position(3)*(N/num_modes)-inset_length/2 ...
        ax5.Position(2)+ax5.Position(4) inset_length inset_length]);
    patch(ax5_inset, 'Vertices', surface_reconstruction.vertices, ...
        'Faces', surface_reconstruction.faces, ...
        'FaceVertexCData', zeros(size(surface_reconstruction.vertices,1),1), ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    elseif strcmpi(hemisphere, 'rh')
...
length_y = (ax5.Position(2)+ax5.Position(4)-init_y)/ ...
    (factor_y*(length(N_interest)-1) + 1);
for jj = 1:length(N_interest)
    N = N_interest(jj);
    ...
    ax7 = axes('Position', ...
        [init_x init_y+factor_y*length_y*(length(N_interest)-jj) ...
            length_x length_y]);
    imagesc(data_Figure1.FC_combined(:,:,jj))
    hold on;
    plot([point_start+1+extra_diagonal point_end], point_start*ones(1,2), ...
        'k-', 'linewidth', 1)
    plot(point_end*ones(1,2), [point_start point_end-1-extra_diagonal], ...
        'k-', 'linewidth', 1)
    plot([point_start point_end-1-extra_diagonal], point_end*ones(1,2), ...
        'k-', 'linewidth', 1)
    plot(point_start*ones(1,2), [point_start+1+extra_diagonal point_end], ...
        'k-', 'linewidth', 1)
    for ii=1:num_parcels-1
        plot((point_start+1+extra_diagonal+(ii-1))*ones(1,2), ...
            point_start+[0 1]+(ii-1), 'k-', 'linewidth', 1)
        plot(point_start+1+extra_diagonal+[0 1]+(ii-1), ...
            (point_start+1+(ii-1))*ones(1,2), 'k-', 'linewidth', 1)

        plot((point_start+1+(ii-1))*ones(1,2), ...
            point_start+1+extra_diagonal+[0 1]+(ii-1), 'k-', 'linewidth', 1)
        plot(point_start+[0 1]+(ii-1), ...
            (point_start+1+extra_diagonal+(ii-1))*ones(1,2), ...
            'k-', 'linewidth', 1)
    end
    hold off;
    caxis([-1 1])
    ...
    text(-5, (num_parcels+extra_diagonal)/2, 'data', ...
        'rotation', 90, 'fontsize', fontsize_axis, ...
        'horizontalalignment', 'center', 'verticalalignment', 'bottom')
    annotation(fig, 'textbox', ...
        [ax7.Position(1)+ax7.Position(3)*0.35, ...
            ax7.Position(2)+ax7.Position(4)*0.95, 0.08, 0.01], ...
            'string', {'recon'; sprintf('(N = %i)', N)}, ...
            'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'horizontalalignment', 'center', ...
                'verticalalignment', 'bottom')
...
%%% panel letters
annotation(fig, 'textbox', ...
    [0.01, 0.99, 0.01, 0.01], 'string', 'a', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', ...
    [0.01, 0.73, 0.01, 0.01], 'string', 'b', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', ...
    [0.52, 0.73, 0.01, 0.01], 'string', 'c', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', ...
    [0.01, 0.5, 0.01, 0.01], 'string', 'd', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', ...
    [0.47, 0.5, 0.01, 0.01], 'string', 'e', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', ...
    [0.84, 0.5, 0.01, 0.01], 'string', 'f', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
...
ax1_1 = axes('Position', ...
    [0.03+init_x+factor_x*length_x*(1-1) init_y+factor_y*length_y*(1.4-1) ...
    length_x*1.2 length_y*1.2]);
data_to_plot = zeros(size(surface_to_plot.vertices,1),1);    
patch(ax1_1, 'Vertices', surface_to_plot.vertices, ...
    'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
...
for basis_ind=1:4
    if basis_ind==1
        ...
        ax1_2_positions = ...
            [0.04 ax1_1.Position(2)+ax1_1.Position(4)*0.81 ...
            length_x*0.55 length_y*0.3];
        box1_positions = ...
            [ax1_1.Position(1)+ax1_1.Position(3)*0.25 ...
            ax1_1.Position(2)+ax1_1.Position(4)*0.55 ...
            ax1_1.Position(3)*0.1 ax1_1.Position(3)*0.15];
    elseif basis_ind==2
        connectome = data_Figure2.network_EDR;
        
        basis_name = {'EDR'};
        
        ax1_2_positions = [0.15 ax1_1.Position(2)+ax1_1.Position(4)*0.81 ...
            ax1_2_positions(3) ax1_2_positions(4)];
        box1_positions = [ax1_1.Position(1)+ax1_1.Position(3)*0.65 ...
            ax1_1.Position(2)+ax1_1.Position(4)*0.6 ax1_1.Position(3)*0.1 ...
            ax1_1.Position(3)*0.15];
    elseif basis_ind==3
        connectome = data_Figure2.network_connectome_1;
        
        basis_name = 'connectome';
        
        ax1_2_positions = [0.057 ax1_1.Position(2)-ax1_1.Position(4)*0.1 ...
            ax1_2_positions(3) ax1_2_positions(4)];
        box1_positions = [ax1_1.Position(1)+ax1_1.Position(3)*0.35 ...
            ax1_1.Position(2)+ax1_1.Position(4)*0.3 ax1_1.Position(3)*0.1 ...
            ax1_1.Position(3)*0.15];
    elseif basis_ind==4
        connectome = data_Figure2.network_connectome_2;
        
        ax1_2_positions = [0.13 ax1_1.Position(2)-ax1_1.Position(4)*0.1 ...
            ax1_2_positions(3) ax1_2_positions(4)];
        box1_positions = [ax1_1.Position(1)+ax1_1.Position(3)*0.65 ...
            ax1_1.Position(2)+ax1_1.Position(4)*0.4 ax1_1.Position(3)*0.1 ...
            ax1_1.Position(3)*0.15];    
    end
    ...
    for ii=1:size(ind_x,1)
        ...
        plot3(parcel_points([ind_y(ii), ind_x(ii)],1), ...
            parcel_points([ind_y(ii), ind_x(ii)],2), ...
            parcel_points([ind_y(ii), ind_x(ii)],3), '-', ...
            'linewidth', linewidth, 'color', what_color)
        
    end
    for ii=1:size(parcel_points,1)
        plot3(parcel_points(ii,1), parcel_points(ii,2), parcel_points(ii,3), ...
            'ko', 'markersize', 2, 'markerfacecolor', 'k')
    end
    hold off;
    view([-90 0])
    set(ax1_2, 'fontsize', fontsize_axis, 'ticklength', [0.02 0.02], ...
        'ylim', [-68 -62], 'zlim', [22 28], ...
    ...
    box1 = annotation('rectangle', box1_positions , ...
            'color', 'k', 'linewidth', 2);
    box2 = annotation('rectangle', ...
        [ax1_2_positions(1)+ax1_2_positions(3)*0.08 ...
        ax1_2_positions(2)-ax1_2_positions(4)*0.08 ...
        ax1_2_positions(3)*0.84 ax1_2_positions(4)+ax1_2_positions(4)*0.16], ...
                'color', 'k', 'linewidth', 2);
    if basis_ind==1 || basis_ind==2
        annotation('line', [box1.Position(1) box2.Position(1)], ...
            [box1.Position(2)+box1.Position(4) box2.Position(2)], ...  
                   'color', 'k', 'linewidth', 2);
        annotation('line', [box1.Position(1)+box1.Position(3) ...
            box2.Position(1)+box2.Position(3)], ...
            [box1.Position(2)+box1.Position(4) box2.Position(2)], ...  
                   'color', 'k', 'linewidth', 2); 
        annotation('textbox', [box2.Position(1), ...
            box2.Position(2)+box2.Position(4)*0.95, box2.Position(3), 0.02], ...  
                   'string', basis_name, 'edgecolor', 'none', ...
                   'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                   'horizontalalignment', 'center', ...
                   'verticalalignment', 'bottom');
    elseif basis_ind==3
        annotation('line', [box1.Position(1) box2.Position(1)], ...
            [box1.Position(2) box2.Position(2)+box2.Position(4)], ...  
                   'color', 'k', 'linewidth', 2);
        annotation('line', [box1.Position(1)+box1.Position(3) ...
            box2.Position(1)+box2.Position(3)], [box1.Position(2) ...
            box2.Position(2)+box2.Position(4)], ...  
                   'color', 'k', 'linewidth', 2); 
        annotation('textbox', [box2.Position(1), ...
            box2.Position(2)-box2.Position(4)*0.15, ...
            box2.Position(3)*2.3, 0.02], ...  
                   'string', basis_name, 'edgecolor', 'none', ...
                   'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                   'horizontalalignment', 'center', 'verticalalignment', 'top');
        annotation('line', [box2.Position(1)+box2.Position(3)*0.9 ...
            box2.Position(1)+box2.Position(3)*1.38], ...
            [box2.Position(2)+box2.Position(4)*0.75 ...
            box2.Position(2)+box2.Position(4)*0.65], ...  
                   'color', 'm', 'linewidth', 3);
        annotation('line', [box2.Position(1)+box2.Position(3)*0.88 ...
            box2.Position(1)+box2.Position(3)*1.38], ...
            [box2.Position(2)+box2.Position(4)*0.45 ...
            box2.Position(2)+box2.Position(4)*0.5], ...  
                   'color', 'm', 'linewidth', 3); 
        annotation('line', [box2.Position(1)+box2.Position(3)*0.95 ...
            box2.Position(1)+box2.Position(3)*1.38], ...
            [box2.Position(2)+box2.Position(4)*0.12 ...
            box2.Position(2)+box2.Position(4)*0.2], ...  
                   'color', 'm', 'linewidth', 3);       
    elseif basis_ind==4
        annotation('line', [box1.Position(1) box2.Position(1)], ...
            [box1.Position(2) box2.Position(2)+box2.Position(4)], ...  
...
for basis_ind=1:2
    ...
    for mode_ind=1:num_modes_to_plot
        ...
        if mode_ind==num_modes_to_plot
            ax2 = axes('Position', ...
                [0.07+0.03+init_x+factor_x*length_x*(mode_ind+2-1) ...
                init_y+factor_y*length_y*(basis_ind-1) length_x length_y]);
        else
            ax2 = axes('Position', ...
                [0.07+init_x+factor_x*length_x*(mode_ind+2-1) ...
                init_y+factor_y*length_y*(basis_ind-1) length_x length_y]);
        end
        patch(ax2, 'Vertices', surface_to_plot.vertices, ...
            'Faces', surface_to_plot.faces, ...
            'FaceVertexCData', data_to_plot_evec(:,mode), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
        if strcmpi(hemisphere, 'lh')
            view([-90 0]);
        elseif strcmpi(hemisphere, 'rh')
        ...
        if basis_ind==1
            if mode_ind==1
                annotation(fig, 'textbox', ...
                    [ax2.Position(1), ax2.Position(2)+ax2.Position(4)*1.4, ...
                    ax2.Position(3), 0.05], 'string', {'mode 1'; '\psi_1'}, ...
                    'edgecolor', 'none', ...
                        'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                        'horizontalalignment', 'center', ...
                        'verticalalignment', 'middle')
            elseif mode_ind==2
                annotation(fig, 'textbox', ...
                    [ax2.Position(1), ax2.Position(2)+ax2.Position(4)*1.4, ...
                    ax2.Position(3), 0.05], 'string', {'mode 2'; '\psi_2'}, ...
                    'edgecolor', 'none', ...
                        'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                        'horizontalalignment', 'center', ...
                        'verticalalignment', 'middle')
            elseif mode_ind==3
                annotation(fig, 'textbox', ...
                    [ax2.Position(1), ax2.Position(2)+ax2.Position(4)*1.4, ...
                    ax2.Position(3), 0.05], 'string', {'mode 3'; '\psi_3'}, ...
                    'edgecolor', 'none', ...
                    'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                    'horizontalalignment', 'center', ...
                    'verticalalignment', 'middle') 
            elseif mode_ind==4
                annotation(fig, 'textbox', ...
                    [ax2.Position(1), ax2.Position(2)+ax2.Position(4)*1.4, ...
                    ax2.Position(3), 0.05], 'string', {'mode 4'; '\psi_4'}, ...
                    'edgecolor', 'none', ...
                    'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                    'horizontalalignment', 'center', ...
                    'verticalalignment', 'middle') 
                ...
                annotation(fig, 'textbox', ...
                    [ax2.Position(1), ax2.Position(2)+ax2.Position(4)*1.4, ...
                    ax2.Position(3), 0.05], 'string', {'mode N'; '\psi_N'}, ...
                    'edgecolor', 'none', ...
                    'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                    'horizontalalignment', 'center', ...
                    'verticalalignment', 'middle')
        ...
        if mode_ind==1
            annotation(fig, 'textbox', ...
                [ax2.Position(1)-0.08, ax2.Position(2)+ax2.Position(4)*0.45, ...
                0.08, 0.02], 'string', basis_name, 'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
        end
    end
    ...
    annotation(fig, 'textbox', ...
        [ax2.Position(1)-0.056, ax2.Position(2)+ax2.Position(4)*0.45, ...
        0.08, 0.02], 'string', '...', 'edgecolor', 'none', ...
                'fontsize', fontsize_axis*2, 'fontweight', 'normal', ...
                'horizontalalignment', 'center', 'verticalalignment', 'middle')
end
...
hold on;
plot(nanmean(resting_recon_corr_geometric,1), ...
    'color', colors2(1,:), 'linewidth', 2, 'displayname', 'geometric')
plot(nanmean(resting_recon_corr_connectome,1), ...
    'color', colors2(2,:), 'linewidth', 2, 'displayname', 'connectome')
plot(nanmean(resting_recon_corr_connectome_density_matched,1), ...
    'color', colors2(3,:), 'linewidth', 2, ...
    'displayname', 'connectome (density matched)')
plot(nanmean(resting_recon_corr_EDR,1), 'color', colors2(4,:), ...
    'linewidth', 2, 'displayname', 'EDR')
hold off;
leg = legend('fontsize', fontsize_axis, 'location', 'southeast', ...
    'interpreter', 'none', 'box', 'off', 'numcolumns', 1);
leg.ItemTokenSize = leg.ItemTokenSize/2;
...
%     clim = clims_combined(kk,:);
    % make absolute colorbar for all three eigenmodes
    clim = [min(clims_combined(:,1)), max(clims_combined(:,2))]; 

    ax4 = axes('Position', ...
        [init_x+factor_x*length_x*(kk) init_y length_x length_y]);
    ...
    set(ax4, 'fontsize', fontsize_axis, 'ticklength', [0.02 0.02], ...
        'xlim', [1 num_modes], 'ytick', yticks, 'yticklabel', lower(tasks), ...
...
cbar = colorbar;
set(cbar, 'ticklength', 0.02, ...
    'Position', [ax4.Position(1)+ax4.Position(3)*1.1 ...
    ax4.Position(2) 0.01 ax4.Position(4)], ...
    'fontsize', fontsize_axis-2);
ylabel(cbar, {'reconstruction accuracy difference'; ...
    ['(geometric ' char(8211) ' others)']}, 'fontsize', fontsize_label)

%%% panel letters
annotation(fig, 'textbox', [0.01, 0.99, 0.01, 0.01], ...
    'string', 'a', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', [0.3, 0.99, 0.01, 0.01], ...
    'string', 'b', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', [0.01, 0.57, 0.01, 0.01], ...
    'string', 'c', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', [0.45, 0.57, 0.01, 0.01], ...
...
%% 图 3.a 左图: 功率谱（人类连接组项目），功率谱表示了信号功率随着频率的变化关系
...
for jj=1:length(N_interest)
    if jj==1
        xline(N_interest(jj), 'k:', 'linewidth', 2, ...
            'label', {'wavelength'; sprintf('~%i mm', wavelengths(jj))}, ...
            'labelhorizontalalignment', 'left', 'HandleVisibility', 'off');
    else
        xline(N_interest(jj), 'k:', 'linewidth', 2, 'label', ...
            sprintf('~%i mm', wavelengths(jj)), ...
            'labelhorizontalalignment', 'left', ...
            'HandleVisibility', 'off');
    end
end
hold off;
leg = legend('fontsize', fontsize_label, 'location', 'east', ...
    'interpreter', 'none', 'box', 'off', 'numcolumns', 1);
leg.ItemTokenSize = leg.ItemTokenSize/2;
set(ax1_1, 'fontsize', fontsize_axis, 'ticklength', [0.02 0.02], ...
    'xlim', xlims, 'ylim', ylims, 'yscale', 'log')
...
for jj = 1:length(N_interest)
    ...
    inset_length = 0.05;
    ax1_1_inset = axes('Position', ...
        [ax1_1.Position(1)+ax1_1.Position(3)*(N/(xlims(2)+3))-inset_length/2 ...
        ax1_1.Position(2)+ax1_1.Position(4) inset_length inset_length]);
    patch(ax1_1_inset, 'Vertices', surface_reconstruction.vertices, ...
        'Faces', surface_reconstruction.faces, 'FaceVertexCData', ...
        zeros(size(surface_reconstruction.vertices,1),1), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    elseif strcmpi(hemisphere, 'rh')
...
%% 图3.a 右图: 功率谱 (NeuroVault)
data_to_plot = nanmean(spectrum_neurovault,2);
ax1_2 = axes('Position', ...
    [init_x+factor_x*length_x*(2-1) init_y+factor_y*length_y*(1-1) ...
    length_x length_y]);
hold on;
...
for jj=1:length(N_interest)
    if jj==1
        ...
        xline(N_interest(jj), 'k:', 'linewidth', 2, ...
            'label', sprintf('~%i mm', wavelengths(jj)), ...
            'labelhorizontalalignment', 'left', 'HandleVisibility', 'off');
    end
end
hold off;
...
for jj = 1:length(N_interest)
    ...
    inset_length = 0.05;
    ax1_2_inset = axes('Position', ...
        [ax1_2.Position(1)+ax1_2.Position(3)*(N/(xlims(2)+3))-inset_length/2 ...
        ax1_2.Position(2)+ax1_2.Position(4) inset_length inset_length]);
    patch(ax1_2_inset, 'Vertices', surface_reconstruction.vertices, ...
        'Faces', surface_reconstruction.faces, ...
        'FaceVertexCData', zeros(size(surface_reconstruction.vertices,1),1), ...
                   'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
...
for ii=1:length(representative_contrasts)
    ...
    data_to_plot_remove_highf = ...
        nanmean(task_recon_corr_remove_highf_geometric.(contrast),1);
    data_to_plot_remove_lowf = ...
        nanmean(task_recon_corr_remove_lowf_geometric.(contrast),1);
    
    if ii<=4
        ax4 = axes('Position', ...
            [init_x+factor_x*length_x*(ii-1) init_y+factor_y*length_y*(2-1) ...
            length_x length_y]);
    else
        ax4 = axes('Position', ...
            [init_x+factor_x*length_x*(ii-4-1+0.25) ...
            init_y+factor_y*length_y*(1-1) length_x length_y]);
    end
    hold on;
    xline(N_percent, 'k:', 'HandleVisibility', 'off');
    if ii==length(representative_contrasts)
        plot(100*(0:(num_modes-1))/num_modes, data_to_plot_remove_lowf, '-', ...
            'color', 'k', 'linewidth', 2, ...
            'displayname', ['removing top long-' newline 'wavelength modes'])
        plot(100*(0:(num_modes-1))/num_modes, data_to_plot_remove_highf, ...
            '--', 'color', 'k', 'linewidth', 2, ...
            'displayname', ['removing top short-' newline 'wavelength modes'])
    end
    plot(100*(0:(num_modes-1))/num_modes, data_to_plot_remove_lowf, '-', ...
        'color', colors(ii,:), 'linewidth', 2, 'HandleVisibility', 'off')
    plot(100*(0:(num_modes-1))/num_modes, data_to_plot_remove_highf, '--', ...
        'color', colors(ii,:), 'linewidth', 2, 'HandleVisibility', 'off')
    plot(N_percent, data_to_plot_remove_lowf(N_interest), 'k.', ...
        'markersize', 25, 'HandleVisibility', 'off')
    plot(N_percent, data_to_plot_remove_highf(N_interest), 'k.', ...
        'markersize', 25, 'HandleVisibility', 'off')
    hold off;
    if ii==length(representative_contrasts)
        leg = legend('fontsize', fontsize_axis, 'interpreter', 'none', ...
            'box', 'off', 'numcolumns', 1, ...
                    'Position', [ax4.Position(1)+ax4.Position(3)*1.3 ...
                    ax4.Position(2)+ax4.Position(4)*0.25 ax4.Position(3)*0.5 ...
                    ax4.Position(3)*0.5]);
        leg.ItemTokenSize = leg.ItemTokenSize/1.4;
    end
    set(ax4, 'fontsize', fontsize_axis, 'ticklength', [0.02 0.02], ...
        'xlim', [0 100], 'ylim', [0 1], 'xtick', 0:25:100)
    if ii>4
    ...
    title(task, 'fontsize', fontsize_axis, 'fontweight', 'normal', ...
        'interpreter', 'none')
    ...
    ax4_2 = axes('Position', ...
        [ax4.Position(1)+ax4.Position(3)*(N_percent/100 + 0.05) ...
        ax4.Position(2)+ ...
        ax4.Position(4)*(data_to_plot_remove_highf(N_interest)-0.35) ...
        surface_length surface_length]);
    patch(ax4_2, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    ...
    annotation(fig, 'arrow', [ax4.Position(1)+ax4.Position(3)*N_percent/100, ...
        ax4_2.Position(1)+ax4_2.Position(3)*0.2], ...
         [ax4.Position(2)+ ...
         ax4.Position(4)*(data_to_plot_remove_highf(N_interest)), ...
         ax4_2.Position(2)+ax4_2.Position(4)*0.8], ...
         'LineStyle', '-', 'HeadLength', 6, 'HeadWidth', 6, 'Color', 'k') 
    
    %%% 重建图（移除低频模式）
    data_to_plot = data_Figure3.task_map_recon_remove_lowf.(contrast);

    ax4_3 = axes('Position', [ax4.Position(1)+ax4.Position(3)*0.05 ...
        ax4.Position(2)+ ...
        ax4.Position(4)*(data_to_plot_remove_lowf(N_interest)-0.4) ...
        surface_length surface_length]);
    patch(ax4_3, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    ...
    annotation(fig, 'arrow', ...
        [ax4.Position(1)+ ...
        ax4.Position(3)*N_percent/100, ...
        ax4_3.Position(1)+ax4_3.Position(3)*0.5], ...
         [ax4.Position(2)+ ...
         ax4.Position(4)*(data_to_plot_remove_lowf(N_interest)), ...
         ax4_3.Position(2)+ax4_3.Position(4)*0.9], ...
         'LineStyle', '-', 'HeadLength', 6, 'HeadWidth', 6, 'Color', 'k')
    ...
    ax4_4 = axes('Position', ...
        [ax4.Position(1)+ax4.Position(3)-surface_length ...
        ax4.Position(2)+ax4.Position(4)-surface_length*0.8 ...
        surface_length surface_length]);
    patch(ax4_4, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    ...
    axis off
    axis image        
    title('data', 'fontsize', fontsize_axis-2, ...
        'fontweight', 'normal', 'interpreter', 'none')
end

%%% panel letters
annotation(fig, 'textbox', [0.015, 0.99, 0.01, 0.01], ...
    'string', 'a', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
annotation(fig, 'textbox', [0.015, 0.6, 0.01, 0.01], ...
    'string', 'b', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center')
...
% 波动力学模型
ax1_1 = axes('Position', ...
    [init_x+factor_x*length_x*(1-1)+length_x*0.25 ...
    init_y+factor_y*length_y*(3.0-1)+length_y/2 length_x length_y/2]);
num_downsampled_vertices = 500;
surface_downsampled = gifti(sprintf('%s/fsLR_%i_midthickness-%s.surf.gii', ...
    data_template_surfaces_folder, num_downsampled_vertices, hemisphere));
data_to_plot = ones(size(surface_downsampled.vertices,1),1);
    
patch(ax1_1, 'Vertices', surface_downsampled.vertices, ...
    'Faces', surface_downsampled.faces, 'FaceVertexCData', data_to_plot, ...
           'EdgeColor', 'k', 'FaceColor', 'interp', 'FaceLighting', ...
           'gouraud', 'linewidth', 0.5);
if strcmpi(hemisphere, 'lh')
    view([-90 0]);
elseif strcmpi(hemisphere, 'rh')
    view([90 0]);
...
annotation(fig, 'textbox', [ax1_1.Position(1)-0.06, ...
    ax1_1.Position(2)+ax1_1.Position(4)*0.45, 0.08, 0.02], ...
    'string', {'wave'; 'model'}, 'edgecolor', 'none', ...
                'fontsize', fontsize_label, 'fontweight', 'bold', ...
                'horizontalalignment', 'center', ...
                'verticalalignment', 'middle', 'color', colors_models(1,:))
            
ax1_2 = axes('Position', [init_x+factor_x*length_x*(1.87-1) ...
    ax1_1.Position(2) 2.2*length_x length_y/2]);
ystart = 0.9;
yspacing = 0.25;
text(0, ystart, 'For each vertex at location $\mathbf{r}$:', ...
    'fontsize', fontsize_label, 'horizontalalignment', 'left', ...
    'verticalalignment', 'middle', 'interpreter', 'latex')
text(0.5, ystart-yspacing*1.6, ...
    ['$\displaystyle\left[\frac{1}{\gamma_s^2}\frac{\partial^2}{\partial t^2}' ...
    ' + \frac{2}{\gamma_s}\frac{\partial}{\partial t} + ' ...
    '1 - r_s^2\nabla^2\right] \phi(\mathbf{r},t) = Q(\mathbf{r},t)$'], ...
    'fontsize', fontsize_label, 'horizontalalignment', 'center', ...
    'verticalalignment', 'middle', 'interpreter', 'latex')
...
% 神经群模型
ax2_1 = axes('Position', [ax1_1.Position(1) ...
    init_y+factor_y*length_y*(2.93-1) length_x length_y/2]);
...
%     plot3(parcel_points([ind_y(ii), ind_x(ii)],1), parcel_points([ind_y(ii), ind_x(ii)],2), parcel_points([ind_y(ii), ind_x(ii)],3), 'k-', 'linewidth', 3*adjacency(ind_y(ii), ind_x(ii)))
    plot3(parcel_points([ind_y(ii), ind_x(ii)],1), ...
        parcel_points([ind_y(ii), ind_x(ii)],2), ...
        parcel_points([ind_y(ii), ind_x(ii)],3), ...
        'k-', 'linewidth', 3*ii/size(ind_x,1))
end
for ii=1:size(parcel_points,1)
    plot3(parcel_points(ii,1), parcel_points(ii,2), parcel_points(ii,3), ...
        'ko', 'markersize', 9, 'markerfacecolor', 'w')
    if ii==1
...
annotation(fig, 'textbox', [ax2_1.Position(1)-0.06, ...
    ax2_1.Position(2)+ax2_1.Position(4)*0.4, 0.08, 0.02], 'string', {'mass'; 'model'}, 'edgecolor', 'none', ...
                'fontsize', fontsize_label, ...
                'fontweight', 'bold', 'horizontalalignment', 'center', ...
                'verticalalignment', 'middle', 'color', colors_models(2,:))
...
text(0, ystart, 'For each region $i$:', ...
    'fontsize', fontsize_label, 'horizontalalignment', 'left', ...
    'verticalalignment', 'middle', 'interpreter', 'latex')
text(0.5, ystart-yspacing*1.6, ['$\displaystyle\frac{dS_i}{dt} = ' ...
    'f(\mathbf{S}, \theta_i, C, G)$'], ...
    'fontsize', fontsize_label, 'horizontalalignment', 'center', ...
    'verticalalignment', 'middle', 'interpreter', 'latex')
...
ax2_3 = axes('Position', ...
    [init_x+factor_x*length_x*(3.3-1) ...
    init_y+factor_y*length_y*(2.98-1) length_x*2.8 length_y]);
...
annotation(fig, 'arrow', ax2_3.Position(1)+[0.02 0.04], ...
                         [ax1_2.Position(2)+ax1_2.Position(4)*0.5 ...
                         ax2_3.Position(2)+ax2_3.Position(4)*0.6], 'Color', 'k')
annotation(fig, 'arrow', ax2_3.Position(1)+[0.02 0.04], ...
                         [ax2_2.Position(2)+ax2_2.Position(4)*0.5 ...
                         ax2_3.Position(2)+ax2_3.Position(4)*0.4], 'Color', 'k')
annotation(fig, 'line', [ax1_1.Position(1)-0.05, ...
    ax1_2.Position(1)+ax1_2.Position(3)*1.05], ...
...
for model_ind = 1:2
    ...
    % FC
    ax2_1 = axes('Position', [init_x+factor_x*length_x*(1-1) ...
        init_y+factor_y*length_y*(-0.98.*[model_ind-2]) length_x length_y*0.8]);
    extra_diagonal = 7;
    FC_combined_model = zeros(num_parcels+extra_diagonal);
    FC_combined_model(find(triu(ones(num_parcels+extra_diagonal), ...
        1+extra_diagonal))) = data_model_FC(triu_ind);
    FC_combined_emp = zeros(num_parcels+extra_diagonal);
    FC_combined_emp(find(triu(ones(num_parcels+extra_diagonal), ...
        1+extra_diagonal))) = data_emp_FC(triu_ind);
    ...
    axis off
    text(-5, (num_parcels+extra_diagonal)/2, 'data FC', ...
        'rotation', 90, 'fontsize', fontsize_axis, ...
        'horizontalalignment', 'center', 'verticalalignment', 'bottom')
    annotation(fig, 'textbox', ...
        [ax2_1.Position(1)+ax2_1.Position(3)*0.12, ...
        ax2_1.Position(2)+ax2_1.Position(4)*0.96, 0.08, 0.02], ...
        'string', 'model FC', 'edgecolor', 'none', ...
                'fontsize', fontsize_axis, 'horizontalalignment', 'center', ...
                'verticalalignment', 'bottom')
    
    if model_ind==1
        t = text(25, -45, 'wave model', 'fontsize', fontsize_label, ...
            'fontweight', 'bold', 'horizontalalignment', 'center', ...
            'verticalalignment', 'middle', ...
            'color', colors_models(1,:));
        text(t.Position(1)+135, t.Position(2), {'($M_{\rm free} = 1$)'}, ...
            'fontsize', fontsize_label, 'fontweight', 'bold', ...
            'horizontalalignment', 'center', ...
            'verticalalignment', 'middle', 'interpreter', 'latex', ...
            'color', colors_models(1,:))
    elseif model_ind==2
        t = text(25, -45, 'mass model', 'fontsize', fontsize_label, ...
            'fontweight', 'bold', 'horizontalalignment', 'center', ...
            'verticalalignment', 'middle', ...
            'color', colors_models(2,:));
        text(t.Position(1)+135, t.Position(2), {'($M_{\rm free} = 4$)'}, ...
            'fontsize', fontsize_label, 'fontweight', 'bold', ...
            'horizontalalignment', 'center', ...
            'verticalalignment', 'middle', 'interpreter', 'latex', ...
            'color', colors_models(2,:))
    ...
    % 边功能耦合
    ax2_2 = axes('Position', [init_x+factor_x*length_x*(2-1) ...
        ax2_1.Position(2) length_x ax2_1.Position(4)]);
    ...
    plot(data_to_plot_x, polyval(polyfit(data_to_plot_x,data_to_plot_y,1), ...
        data_to_plot_x), ...
        'r-', 'linewidth', 2);
    hold off;
    ...
    text(max(get(gca,'xlim')), min(get(gca,'ylim'))+ ...
        0.1*[max(get(gca,'ylim'))-min(get(gca,'ylim'))], ...
        sprintf('r = %.2f', rho), 'color', 'r', ...
        'fontsize', fontsize_axis, 'fontweight', 'bold', ...
        'verticalalignment', 'middle', 'horizontalalignment', 'right');
    box off;
    
    % 节点功能耦合
    ax2_3 = axes('Position', [init_x+factor_x*length_x*(3-1) ...
        ax2_1.Position(2) length_x ax2_1.Position(4)]);
    ...
    % phase FCD
    ax2_4 = axes('Position', ...
        [init_x+factor_x*length_x*(4-1) ax2_1.Position(2) ...
        length_x ax2_1.Position(4)]);
    hold on;
    histogram(data_emp_FCD(:), 'normalization', 'pdf', ...
        'facecolor', cb(1,:), 'edgecolor', 'none', ...
        'displayname', 'data', 'facealpha', 0.6)
    histogram(data_model_FCD(:), 'normalization', 'pdf', ...
        'facecolor', cb(4,:), 'edgecolor', 'none', ...
        'displayname', 'model', 'facealpha', 0.6)
    hold off;
    if model_ind==2
        objects = findobj(gca, 'type', 'histogram');
        set(ax2_4, 'fontsize', fontsize_axis, 'ticklength', [0.02, 0.02], ...
            'xlim', [0 1], 'children', flipud(get(gca,'children')))
        leg = legend([objects(2) objects(1)], {'data', 'model'}, ...
            'fontsize', fontsize_axis, 'location', 'northeast', ...
            'interpreter', 'none', 'box', 'off', 'numcolumns', 1);
    else
        objects = findobj(gca, 'type', 'histogram');
        set(ax2_4, 'fontsize', fontsize_axis, ...
            'ticklength', [0.02, 0.02], 'xlim', [0 1])
        leg = legend('fontsize', fontsize_axis, 'location', 'northeast', ...
            'interpreter', 'none', 'box', 'off', 'numcolumns', 1);
    end
    leg.ItemTokenSize = leg.ItemTokenSize/2;
    ...
    text(max(get(gca,'xlim')), ...
        min(get(gca,'ylim'))+0.1*[max(get(gca,'ylim'))- ...
        min(get(gca,'ylim'))], ...
        sprintf('KS = %.2f', model_fit.KS(model_ind)), 'color', 'r', ...
        'fontsize', fontsize_axis, 'fontweight', 'bold', ...
        'verticalalignment', 'middle', 'horizontalalignment', 'right');
    box off
    ...
    if model_ind==1
        annotation(fig, 'line', ...
            [ax2_1.Position(1)-0.03, ax2_4.Position(1)+ax2_4.Position(3)], ...
            (ax2_1.Position(2)-0.065)*ones(1,2))
    end
end


%% 图4.c: 波动力学模型可视化仿真的时间序列
t_interest = [6, 16, 36, 42];
t_interest_ind = dsearchn(model_wave_visual.tspan', t_interest');
data_to_plot = ...
    model_wave_visual.simulated_neural_visual_vertex(:,t_interest_ind);
data_to_plot = data_to_plot./repmat(max(data_to_plot,[],1), ...
    size(data_to_plot,1), 1);
data_to_plot(isnan(data_to_plot)) = 0;
...
for t_ind=1:length(t_interest_ind)
    ...
    ax4_1 = axes('Position', ...
        [surf_init_x+surf_factor_x*surf_length_x*(t_ind-1) ...
        surf_init_y+length_y/2.3 surf_length_x surf_length_y]);
    patch(ax4_1, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, ...
        'FaceVertexCData', data_to_plot(:,t_ind), ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    if strcmpi(hemisphere, 'lh')
        view([-90 0]);
    elseif strcmpi(hemisphere, 'rh')
    ...
    axis off
    axis image
    obj_title = title(sprintf('t = %i ms', (t)), 'fontsize', fontsize_axis, ...
        'fontweight', 'normal');
    obj_title.Position = obj_title.Position + [0 0 18];
    
    ax4_2 = axes('Position', ...
        [surf_init_x+surf_factor_x*surf_length_x*(t_ind-1) ...
        surf_init_y surf_length_x surf_length_y]);
    patch(ax4_2, 'Vertices', surface_to_plot.vertices, ...
        'Faces', surface_to_plot.faces, ...
        'FaceVertexCData', data_to_plot(:,t_ind), ...
               'EdgeColor', 'none', 'FaceColor', 'interp');
    ...
    if t_ind==1
        annotation(fig, ...
            'arrow', ax4_2.Position(1)+ax4_2.Position(3).*[0.09, 0.01], ...
             ax4_2.Position(2)+ax4_2.Position(4).*[0.5, 0.75], ...
             'LineStyle', '-', 'HeadLength', 8, 'HeadWidth', 8, 'Color', 'r')
        annotation(fig, ...
            'arrow', ax4_2.Position(1)+ax4_2.Position(3).*[0.1, 0.19], ...
    ...
    elseif t_ind==2
        annotation(fig, ...
            'arrow', ax4_2.Position(1)+ax4_2.Position(3).*[0.09, 0.01], ...
             ...
             'LineStyle', '-', 'HeadLength', 8, 'HeadWidth', 8, 'Color', 'r')
        annotation(fig, ...
            'arrow', ax4_2.Position(1)+ax4_2.Position(3).*[0.15, 0.21], ...
             ax4_2.Position(2)+ax4_2.Position(4).*[0.36, 0.14], ...
             'LineStyle', '-', 'HeadLength', 8, 'HeadWidth', 8, 'Color', 'r')
    elseif t_ind==3
        annotation(fig, ...
            'arrow', ax4_1.Position(1)+ax4_1.Position(3).*[0.91, 0.68], ...
             ax4_1.Position(2)+ax4_1.Position(4).*[0.66, 0.81], ...
             'LineStyle', '-', 'HeadLength', 8, 'HeadWidth', 8, 'Color', 'r')
        annotation(fig, ...
            'arrow', ax4_1.Position(1)+ax4_1.Position(3).*[0.85, 0.55], ...
...
ax5 = axes('Position', ...
    [surf_init_x+factor_x*length_x*0.25 init_y+factor_y*length_y*(2-1) ...
    length_x*2 length_y]);
hold on;
for jj=1:length(ROIS)
	...
	plot(model_wave_visual.tspan, data_to_plot(tpeak_ind(jj),:), ...
        'Color', colors3(jj,:), 'linewidth', 2, 'displayname', ROI_name)
end
hold off;
...
BOUNDARY = findROIboundaries(surface_to_plot.vertices, ...
    surface_to_plot.faces,parc_tpeak,boundary_method);
    
ax5_1 = axes('Position', [ax5.Position(1)+ax5.Position(3)*0.5 ...
    ax5.Position(2)+ax5.Position(4)*0.55 ax5.Position(3)*0.55 ...
    ax5.Position(4)*0.45]);
patch(ax5_1, 'Vertices', surface_to_plot.vertices, ...
    'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
           'EdgeColor', 'none', 'FaceColor', 'flat');
hold on;
for ii = 1:length(BOUNDARY)
    plot3(BOUNDARY{ii}(:,1), BOUNDARY{ii}(:,2), BOUNDARY{ii}(:,3), ...
...
ax5_2 = axes('Position', ...
    [ax5_1.Position(1) ...
    ax5_1.Position(2)-ax5_1.Position(4)*1.02 ax5_1.Position(3) ...
    ax5_1.Position(4)]);
patch(ax5_2, 'Vertices', surface_to_plot.vertices, ...
    'Faces', surface_to_plot.faces, 'FaceVertexCData', data_to_plot, ...
           'EdgeColor', 'none', 'FaceColor', 'flat');
hold on;
for ii = 1:length(BOUNDARY)
...
%% 图4.e: 到达峰值的时间 vs myelin
ax6 = axes('Position', ...
    [surf_init_x+factor_x*length_x*0.25 init_y+factor_y*length_y*(1-1) ...
    ax5.Position(3) ax5.Position(4)]);
...
set(ax6, 'fontsize', fontsize_axis, 'ticklength', [0.02, 0.02], ...
    'xlim', [min(data_to_plot_x) max(data_to_plot_x)], ...
    'ylim', [min(data_to_plot_y) max(data_to_plot_y)])
...
text(min(get(gca,'xlim'))+0.05*[max(get(gca,'xlim'))-min(get(gca,'xlim'))], ...
    min(get(gca,'ylim'))+0.25*[max(get(gca,'ylim'))-min(get(gca,'ylim'))], ...
    ['r = ', sprintf('%.2f', rho)], 'color', 'r', ...
    'fontsize', fontsize_axis, 'fontweight', 'bold', ...
    'verticalalignment', 'middle', 'horizontalalignment', 'left');
text(min(get(gca,'xlim'))+0.05*[max(get(gca,'xlim'))-min(get(gca,'xlim'))], ...
    min(get(gca,'ylim'))+0.12*[max(get(gca,'ylim'))-min(get(gca,'ylim'))], ...
    sprintf('p_{spin} = %.3f', pval), 'color', 'r', ...
    'fontsize', fontsize_axis, 'fontweight', 'bold', ...
    'verticalalignment', 'middle', 'horizontalalignment', 'left');
box off

%%% panel letters
a1 = annotation(fig, 'textbox', [0.01, 0.98, 0.01, 0.01], ...
    'string', 'a', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
a2 = annotation(fig, ...
    'textbox', ...
    [a1.Position(1), a1.Position(2)-0.32, a1.Position(3), a1.Position(4)], ...
    'string', 'b', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
a3 = annotation(fig, ...
    'textbox', ...
    [a1.Position(1)+0.7, a1.Position(2), a1.Position(3), a1.Position(4)], ...
    'string', 'c', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
a4 = annotation(fig, ...
    'textbox', ...
    [a3.Position(1), a2.Position(2), a1.Position(3), a1.Position(4)], ...
    'string', 'd', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
a5 = annotation(fig, ...
    'textbox', ...
    [a3.Position(1), a4.Position(2)-0.32, a1.Position(3), a1.Position(4)], ...
...
for structure_ind = 1:length(structures)
    ...
    %% 图5 a-c: 梯度 vs 特征模式
    lim_gradients = double( ...
        [min(subcortical_gradients.(structure)(:,mode_interest), [], 'all'), ...
        max(subcortical_gradients.(structure)(:,mode_interest), [], 'all')]);
    for ii = 1:length(mode_interest)
        mode = mode_interest(ii);
        
        ax1 = axes('Position', ...
            [init_x+length_x*0.67+factor_x*length_x*(structure_ind-1) ...
            init_y+factor_y*length_y*(2-1)- ...
            0.05+length_y/(length(mode_interest)-0.)* ...
            (-(ii-length(mode_interest))) ...
            length_x*0.33 length_y/(length(mode_interest)+0.85)]);
        ...
        plot(data_to_plot_x, ...
            polyval( ...
            polyfit(data_to_plot_x,data_to_plot_y,1), data_to_plot_x), ...
            'r-', 'linewidth', 2);
        hold off;
        ...
        [rho,pval] = corr(data_to_plot_x, data_to_plot_y, 'type', 'pearson');
        text(lim_gradients(2), ...
            min(get(gca,'ylim'))+0.09*[max(get(gca,'ylim'))- ...
            min(get(gca,'ylim'))], sprintf('r = %.3f', rho), 'color', 'r', ...
            'fontsize', fontsize_axis, 'fontweight', 'bold', ...
            'verticalalignment', 'middle', 'horizontalalignment', 'right');
        box off;
        ...
        [rho,~] = corr(subcortical_gradients.(structure)(:,mode), ...
            data_to_plot, 'type', 'pearson');
        if rho<0
            data_to_plot = -data_to_plot;
        end
        ...
        ax1_1 = axes('Position', ...
            [ax1.Position(1)-0.21 ax1.Position(2)+ax1.Position(4)*0 ...
            length_x*0.34 ax1.Position(4)]);
%         scatter3(subcortical_locs.(structure)(sort_ind,1), subcortical_locs.(structure)(sort_ind,2), subcortical_locs.(structure)(sort_ind,3), markersize, new_map, 'filled');
        scatter3(subcortical_locs.(structure)(sort_ind,1), ...
            subcortical_locs.(structure)(sort_ind,2), ...
            subcortical_locs.(structure)(sort_ind,3), ...
            markersize, data_to_plot(sort_ind), 'filled');
        colormap(ax1_1,bluewhitered)
        set(ax1_1, 'xlim', [min(subcortical_locs.(structure)(sort_ind,1)), ...
            max(subcortical_locs.(structure)(sort_ind,1))], ...
                 'ylim', [min(subcortical_locs.(structure)(sort_ind,2)), ...
                 max(subcortical_locs.(structure)(sort_ind,2))], ...
                 'zlim', [min(subcortical_locs.(structure)(sort_ind,3)), ...
                 max(subcortical_locs.(structure)(sort_ind,3))])
        axis square
        view([views(structure_ind,1) views(structure_ind,2)])
        axis off
        
        annotation(fig, ...
            'textbox', [ax1_1.Position(1), ...
            ax1_1.Position(2)+ax1_1.Position(4)*0.88, ...
            ax1_1.Position(3), 0.01], ...
            'string', sprintf('mode %i', mode), 'edgecolor', 'none', ...
        'fontsize', fontsize_axis, 'fontweight', 'normal', ...
        'horizontalalignment', 'center', 'verticalalignment', 'middle')   
        ...
        ax1_2 = axes('Position', ...
            [ax1_1.Position(1)+ax1_1.Position(3)*1 ax1_1.Position(2) ...
            ax1_1.Position(3) ax1_1.Position(4)]);
%         scatter3(subcortical_locs.(structure)(sort_ind,1), subcortical_locs.(structure)(sort_ind,2), subcortical_locs.(structure)(sort_ind,3), markersize, new_map, 'filled');
        scatter3(subcortical_locs.(structure)(sort_ind,1), ...
            subcortical_locs.(structure)(sort_ind,2), ...
            subcortical_locs.(structure)(sort_ind,3), ...
        ...
        set(ax1_2, 'xlim', [min(subcortical_locs.(structure)(sort_ind,1)), ...
            max(subcortical_locs.(structure)(sort_ind,1))], ...
                 'ylim', [min(subcortical_locs.(structure)(sort_ind,2)), ...
                 max(subcortical_locs.(structure)(sort_ind,2))], ...
                 'zlim', [min(subcortical_locs.(structure)(sort_ind,3)), ...
        ...
        annotation(fig, 'textbox', ...
            [ax1_2.Position(1), ...
            ax1_2.Position(2)+ax1_2.Position(4)*0.88, ...
            ax1_2.Position(3), 0.01], ...
            'string', sprintf('gradient %i', mode), 'edgecolor', 'none', ...
        'fontsize', fontsize_axis, 'fontweight', 'normal', ...
        'horizontalalignment', 'center', 'verticalalignment', 'middle') 
        ...
        if ii==length(mode_interest)
            ...
            xstart = min(subcortical_locs.(structure)(:,1)); xend = ...
                min(subcortical_locs.(structure)(:,1)) + ...
                xfrac*(max(subcortical_locs.(structure)(:,1))-...
                min(subcortical_locs.(structure)(:,1)));
            % ystart = min(y); yend = min(y) + yfrac*(max(y)-min(y));
            ystart = max(subcortical_locs.(structure)(:,2)); yend = ...
                max(subcortical_locs.(structure)(:,2)) - ...
                yfrac*(max(subcortical_locs.(structure)(:,2))-...
                min(subcortical_locs.(structure)(:,2)));
            zstart = min(subcortical_locs.(structure)(:,3)); zend = ...
                min(subcortical_locs.(structure)(:,3)) + ...
                zfrac*(max(subcortical_locs.(structure)(:,3))-...
                min(subcortical_locs.(structure)(:,3)));

            if strcmpi(structure, 'tha')
                ax1_1_dir = axes('Position', ...
                    [ax1_1.Position(1)+0.01 ax1_1.Position(2)-0.12 0.3 0.3]);
            elseif strcmpi(structure, 'striatum')
                ax1_1_dir = axes('Position', ...
                    [ax1_1.Position(1)+0.01 ax1_1.Position(2)- ...
                    0.07 ax1_1_dir.Position(3) ax1_1_dir.Position(4)]);
            elseif strcmpi(structure, 'hippo')
                ax1_1_dir = axes('Position', ...
                    [ax1_1.Position(1)-0.12 ax1_1.Position(2)- ...
                    0.18 ax1_1_dir.Position(3) ax1_1_dir.Position(4)]);
            end
            hold on;
            ...
            hold off;
            text(min(subcortical_locs.(structure)(:,1)) + ...
                (xfrac+0.05*xfrac)*(max(subcortical_locs.(structure)(:,1))- ...
                min(subcortical_locs.(structure)(:,1))), ystart, zstart, 'R') 
            text(xstart, max(subcortical_locs.(structure)(:,2)) - ...
                (yfrac+0.1*yfrac)*(max(subcortical_locs.(structure)(:,2))- ...
                min(subcortical_locs.(structure)(:,2))), zstart, 'P') 
            text(xstart, ystart, min(subcortical_locs.(structure)(:,3)) + ...
                (zfrac+0.35*zfrac)*(max(subcortical_locs.(structure)(:,3))- ...
                min(subcortical_locs.(structure)(:,3))), 'D') 
            xlim([min(subcortical_locs.(structure)(:,1)) ...
                max(subcortical_locs.(structure)(:,1))])
            ylim([min(subcortical_locs.(structure)(:,2)) ...
                max(subcortical_locs.(structure)(:,2))])
            zlim([min(subcortical_locs.(structure)(:,3)) ...
                max(subcortical_locs.(structure)(:,3))])
            [az, el] = view(ax1_1);
            view([az el])
            axis off
        end
    ...
    ax2 = axes('Position', ...
        [init_x+factor_x*length_x*(structure_ind-1) ...
        init_y+factor_y*length_y*(0.98-1) length_x length_y]);
    ...
    ax2_2 = axes('Position', ...
        [ax2.Position(1) ax2.Position(2)+ax2.Position(4)*0.78 ...
        ax2.Position(3) ax2.Position(4)*0.18]);
    colororder({'k', 'b'})
    yyaxis(ax2_2, 'left')
    bar(1:size(subcortical_corr.(structure),1), ...
        max(abs((subcortical_corr.(structure))),[],1), ...
        'facecolor', 0.8*ones(1,3))
    set(ax2_2, 'fontsize', fontsize_axis-2, 'ticklength', [0.02, 0.02], ...
        'xtick', 5:5:20, 'xticklabel', {}, ...
        'xlim', [1-0.5, size(subcortical_corr.(structure),1)+0.5], ...
        'ylim', [0 1])
    ylabel('max |r|', 'fontsize', fontsize_label-2)
    box on
    
    yyaxis(ax2_2, 'right')
    plot(1:size(subcortical_corr.(structure),1), ...
        subcortical_gradients_variance.(structure)...
        (1:size(subcortical_corr.(structure),1)), ...
        'b.-', ...
    ...
    %%% 结构名
    annotation(fig, 'textbox', ...
        [ax1.Position(1)-0.19, 0.97, length_x, 0.01], ...
        'string', structure_name, 'edgecolor', 'none', ...
            'fontsize', fontsize_label, 'fontweight', 'normal', ...
            'horizontalalignment', 'center', 'verticalalignment', 'middle')
end
...
a2 = annotation(fig, 'textbox', ...
    [a1.Position(1), 0.42, a1.Position(3), a1.Position(4)], ...
    'string', 'd', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
a3 = annotation(fig, 'textbox', ...
    [a1.Position(1)+0.33, a1.Position(2), a1.Position(3), a1.Position(4)], ...
    'string', 'b', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
annotation(fig, 'textbox', ...
    [a3.Position(1), a2.Position(2), a1.Position(3), a1.Position(4)], ...
...
a4 = annotation(fig, 'textbox', ...
    [a1.Position(1)+0.66, a1.Position(2), a1.Position(3), a1.Position(4)], ...
    'string', 'c', 'edgecolor', 'none', ...
        'fontsize', 20, 'fontweight', 'b', 'horizontalalignment', 'center');
annotation(fig, 'textbox', ...
    [a4.Position(1), a2.Position(2), a1.Position(3), a1.Position(4)], ...
